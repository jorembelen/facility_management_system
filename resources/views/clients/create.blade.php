            ...
            <div class="card-body">
                <form class="form-horizontal form-disabled-button" method="POST" action="{{ route('client-appointments.store') }}" enctype="multipart/form-data" id="client-app-create">
                    ...
                    <div class="form-group">
                        ...
                        <label class="custom-control custom-radio">
                            ...
                            <fieldset disabled>
                                ...
                                <span class="custom-control-label disabled">{{ $item->time }}  - <span class="badge badge-danger">Appointment is Full</span></span>
                            </fieldset>
                            @else
                                <input name="schedule_time" type="radio" value="{{ $item->time }}" class="custom-control-input">
                                <span class="custom-control-label">{{ $item->time }} </span>
                            @endif
                          </label>
                        @endforeach
                    </div>
                    <div class="form-group">
                        ...
                        <select name="job_description" class="form-control" id="appointment_frm">
                    ...
                    <div class="form-group">
                        ...
                        <select name="job_location[]" class="form-control select-location" multiple>
                            <option value="">Select ...</option>
