                    ...
                    <form wire:submit.prevent="submit">
                        <div class="form-group">
                            ...
                            <select  wire:model="selectedCategories" class="form-control">
                                ...
                                <option value="10">Common Area</option>
                            </select>
                        ...
                        @php
                        $facilities = App\Models\Building::whereNotIn('facility_type_id', $facilityTypeId)->get();
                        @endphp
                        <div class="form-group">
                            <label class="form-label">Building </label>
                            <div wire:ignore>
                                <select wire:change="$emit('classChanged', $event.target.value)"  class="form-control" id="location">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" wire:model.defer="job_location" class="form-control" placeholder="Please enter job location">
                            @error('job_location')
                            <div class="text-danger">
                                {{ $message }}
                            </div>
...
<script>
    $('form').submit(function() {
        @this.set('building_id', $('#location').val());
    })
</script>
