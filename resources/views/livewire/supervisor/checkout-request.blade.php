                        ...
                        @foreach ($buildings as $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" wire:click.prevent="approveShow('{{$item->tenant->badge}}')"><span class="badge badge-success">Approve</span></a>
                                    @endif
                                </td>
                        </tr>
                        @endforeach
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body m-3">
                ...
                <div class="form-group" wire:loading.remove wire:target="attachment">
            ...
            <div class="modal-footer">
                ...
                <div wire:loading wire:target="attachment" class="progress-bar progress-bar-striped progress-bar-animated mt-2" role="status" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">Uploading . . .</div>

                <div wire:loading.remove wire:target="{{ empty($attachment) ? 'attachment' : 'submit' }}">
