            ...
            <div class="card">
                    ...
                    <form wire:submit.prevent="getSchedule">
                        <div class="alert alert-primary alert-dismissible" role="alert">
                            ...
                            <div class="alert-message">
                                <strong>Hello there!</strong> Please select Facility, work category and date to proceed!
                            </div>
                        </div>
                        <div wire:loading.remove wire:target="getSchedule">
                            ...
                            <div class="form-group">
                                ...
                                <div wire:ignore>
                                    <select wire:model="building_id"  class="form-control select2" id="building">
                                        <option value="">Select Building</option>
                                        @foreach ($facilities as $data)
                                        <option value="{{ $data->id }}">{{ $data->buildingInfo() }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                @error('building_id')
                ...
                <div class="card-body">
                    <form wire:submit.prevent="createAppointment">
                        <div class="form-group">
                            <label class="form-label">Facility Information</label>
                            <h4>{{ $buildingInfo->buildingInfo() }}  </h4>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Work Category</label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div wire:ignore>
                                        <input type="text" class="form-control flatpickr flatpickr-input active" id="flatpickrOne" wire:model.defer="time_start" placeholder="select start time">
                                    </div>
                                    @error('time_start')
                                    <div class="text-danger">
                                        {{ $message }}
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div wire:ignore>
                                        <input type="text" class="form-control flatpickr flatpickr-input active" id="flatpickrTwo" wire:model.defer="time_end" placeholder="select end time">
                                    </div>
                                    @error('time_end')
                                    <div class="text-danger">
                                        {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <div wire:ignore>
                                <select wire:model="job_description" class="form-control">
                        ...
                        <div class="modal-footer">
                            ...
                            <div wire:loading.remove wire:target="createAppointment">
                        ...
                        @include('scripts.supervisor-appointment-two')
                    </form>
                </div>
                @endif
                @include('scripts.supervisor-appointment')
            </div>
        </div>
    </div>
