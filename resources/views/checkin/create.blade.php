        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="issued_date" placeholder="select date">
                </div>
                <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ \URL::previous() }}" class="btn btn-danger waves-effect disabled-button-prevent">Cancel</a>
            </form>
            </div>
        </div>
    </div>
