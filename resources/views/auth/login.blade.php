            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form class="text-left" method="POST" action="{{ route('login.perform') }}"  id="login">
                            ...
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input  type="text" class="form-control{{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ old('username') }}" placeholder="please enter your username / email" required autofocus>
                                ...
                                <div id="password-field" class="field-wrapper input mb-2">
                                    ...
                                    <input  type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required autocomplete="" id="password">
                                    ...
                                    @endif
                                    <div class="field-wrapper text-center keep-logged-in mt-2">
                                        <div class="n-chk new-checkbox checkbox-outline-primary">
                                            <label class="new-control new-checkbox checkbox-outline-primary">
                                                <input type="checkbox" class="new-control-input" name="remember" id="remember-check">
                                ...
                                <div class="text-center mt-2">
                                    <a href="#" class="video-btn text-primary" data-toggle="modal" data-src="{{ Storage::disk('s3')->url('help-assets/login.mp4') }}" data-target="#myModal">
                                        Click here for new Tenant Login
                                    </a>
                                </div>
