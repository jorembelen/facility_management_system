                ...
                <table id="datatables-buttons" class="table table-striped dataTable no-footer dtr-inline" style="width: 100%;" role="grid" aria-describedby="datatables-reponsive_info">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Click to Assign {{ $building->id }}" href="{{ route('tenant.assign', $building->id) }}"><span class="badge badge-primary">Assign</span></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
