                        ...
                        <tbody>
                            @foreach ($appointments as $appointment)
                                <tr>
                                    ...
                                    <td>
                                        <a data-toggle="tooltip" data-placement="top" title="" data-original-title="View Tenant Info" href="{{ route('appointments.show', $appointment->id) }}">{{ $appointment->client->name }}</a>
                                    </td>
                                    <td>
